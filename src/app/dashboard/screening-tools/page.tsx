    ...
    <div className="p-8 space-y-8">
        ...
        {screeningTools.map((tool) => (
          <div key={tool.id} onClick={() => handleToolClick(tool.id)} className="bg-white rounded-xl p-6 shadow-sm border border-gray-100 hover:shadow-md transition-shadow duration-200 group cursor-pointer">
            ...
            <button 
              ...
              className={`w-full mt-4 py-3 px-4 rounded-lg font-medium text-sm transition-colors ${
              tool.color === 'purple' ? 'bg-purple-50 text-purple-700 hover:bg-purple-100' :
              tool.color === 'blue' ? 'bg-blue-50 text-blue-700 hover:bg-blue-100' :
              tool.color === 'pink' ? 'bg-pink-50 text-pink-700 hover:bg-pink-100' :
              tool.color === 'green' ? 'bg-green-50 text-green-700 hover:bg-green-100' :
              tool.color === 'orange' ? 'bg-orange-50 text-orange-700 hover:bg-orange-100' :
      ...
      <div className="bg-gradient-to-br from-purple-50 to-blue-50 rounded-xl p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <button className="bg-white rounded-lg p-4 shadow-sm border border-gray-100 hover:shadow-md transition-shadow text-left">
